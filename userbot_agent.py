...
ВАЖНО: Не пиши никаких вступлений типа "Вот анализ". Только готовый пост. и пиши на русском всегда и ещё в конце самом пииши что помощь и обратная связь в этом боте @DEXQsquad_bot""" 
